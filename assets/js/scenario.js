var scenario = {
    ...
    stages: [
        ...
        scene.counter.set(300, 400, 500),
        scene.playSound('siri', scene.counter.set(350, 400, 500)),
        scene.playSound('sechin', scene.counter.set(350, 500, 500)),
        scene.showChangeLeftAvatarAlert(),
        scene.hideChangeLeftAvatarAlert(scene.like.showLeft(128, 500)),
        scene.counter.set(350, 550, 500),
        scene.counter.set(350, 600, 500),
        scene.counter.set(350, 650, 500),
        scene.counter.set(350, 800, 500),
        scene.counter.set(350, 750, 500),
